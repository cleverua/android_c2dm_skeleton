...
registration ID to application server if you want to receive C2DM messages.


== EXAMPLES

To see an example please launch the C2DM_Skeleton application in Android device emulator.
